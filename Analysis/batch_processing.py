...
def compute_classification_metrics(rootdir, cachedir, outfile, nrs, deltavs, densities, f=f_exp):
    ...
    np.savez(outfile, baseline_cms=baseline_cms, mixvel_cms=mixvel_cms,
...
if __name__ == '__main__':
    ...
    cachedir = '/Users/nabeel/Data/cache/update_7222_cosweight'
    # cachedir = '/Volumes/Backyard/Data/cache/update_2222'
    outdir = '/Users/nabeel/Data/output/'
    outfile = 'update_7222_cosweight.npz'
